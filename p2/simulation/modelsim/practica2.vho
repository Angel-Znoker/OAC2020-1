...
-- E	=>  Location: PIN_E6,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \inst5~0_combout\ = (\E~input_o\ & ((\D1~q\) # (\D0~q\)))
...
-- Equation(s):
-- \inst6~0_combout\ = (\E~input_o\ & ((\D1~q\) # (!\D0~q\)))
